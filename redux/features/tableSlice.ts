...
const initialState = {
  data: [
    ...
    { name: "Riya", email: "riya@example.com", age: 22, role: "Intern" },
    { name: "Arjun", email: "arjun@example.com", age: 28, role: "Developer" },
    { name: "Sneha", email: "sneha@example.com", age: 25, role: "Designer" },
    { name: "Karan", email: "karan@example.com", age: 30, role: "Manager" },
    { name: "Pooja", email: "pooja@example.com", age: 27, role: "Developer" },
    { name: "Vikram", email: "vikram@example.com", age: 35, role: "Team Lead" },
    { name: "Anita", email: "anita@example.com", age: 24, role: "QA Engineer" },
    { name: "Rahul", email: "rahul@example.com", age: 29, role: "Developer" },
    { name: "Meera", email: "meera@example.com", age: 26, role: "HR" },
  ] as TableRow[],
